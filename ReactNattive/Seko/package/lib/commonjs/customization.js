...
exports.getIOSCustomization = exports.getAndroidCustomization = exports.defaultCustomization = void 0;
...
const getAndroidCustomization = customization => {
  if (!customization) {
...
exports.getAndroidCustomization = getAndroidCustomization;
const getIOSCustomization = customization => {
  if (!customization) {
    customization = defaultCustomization;
  }
  return {
...
exports.getIOSCustomization = getIOSCustomization;
